...
<div class="slideshow-container">
      ...
      <div class="mySlides fade" style="width:1700px; margin-top:300px; padding-left:250px;">
		    ...
		    <a href="/board/saleBoard" class="btn-get-started scrollto">구경하러 가기</a>
		   	<p style="color: white; font-size: 20px;" >저희 A.L.T에 서비스에 만족하고 싶으시다면 좋아요 버튼을 눌러주세요.</p>
		   	<iframe src="https://www.facebook.com/plugins/like.php?href=http%3A%2F%2Flocalhost%3A8080%2F&width=108&layout=button_count&action=like&size=large&share=false&height=21&appId" width="200" height="30" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowfullscreen="true" allow="autoplay; clipboard-write; encrypted-media; picture-in-picture; web-share"></iframe>
